...
module.exports.handleEvent = async function ({ api, event, Users }) {
  ...
  const responses = {
    ...
    "admin": "He is M1X NIROB তাকে সবাই বার হিসেবেও চিনে না😘☺️",
    "babi": "এ তো হাছিনা হে মেরে দিলকি ধারকান হে মেরি জান হে😍.",
    "chup": "তুই চুপ চুপ কর পাগল ছাগল",
    "assalamualaikum": "وَعَلَيْكُمُ السَّلَامُ وَرَحْمَةُ اللهِ وَبَرَكَاتُهُ 💖",
    "fork": "https://github.com/NiROB-XD69/M1X-NIROB.git",
    "kiss me": "তুমি পঁচা তোমাকে কিস দিবো না 🤭",
    "thanks": "এতো ধন্যবাদ না দিয়ে আমার বস নিরব রে তোর গার্লফ্রেন্ড টা দিয়ে দে..!🐸🥵",
    "i love you": "মেয়ে হলে আমার বস নিরব এর ইনবক্সে এখুনি গুঁতা দিন🫢😻",
    ...
    "tor nam ki": "MY NAME IS M1X NIROB CHAT BOT",
    ...
    "love you": "ভালোবাসা নামক আবলামী করতে চাইলে Boss নিরবের এর ইনবক্সে গুতা দিন 😘",
